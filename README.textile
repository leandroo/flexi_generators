...
2. Open a shell and run @rake gems:install@ and @rake db:migrate@ to create your database and installs all required gems
3. Start your server with @./script/server@
