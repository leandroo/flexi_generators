...
2. Open a shell and run <pre>rake db:migrate</pre> to create your database and setup the prepared defaults.
3. Start your server with <pre>./script/server</pre>
